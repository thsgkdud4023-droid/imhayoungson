  ...
  projects: [
    {
      ...
      client: "IBK기업은행",
      program: "1st LAB",
      category: "Financial Open Innovation · PoC",
      message: "금융 현업 수요 기반 스타트업 발굴 및 PoC 운영",
      counts: [
    ...
    },
    {
      ...
      message: "현업 Pain Point에서 PoC 과제까지",
      counts: [],
      funnel: null,
      stats: [
        { value: 11, label: "현업부서 인터뷰" },
        { value: 155, label: "유효 지원기업" },
        { value: 4, label: "최종 선발기업" },
      ],
      flow: ["Pain Point", "Sourcing", "Evaluation", "PoC"],
      bullets: [
        "11개 현업부서 인터뷰 기반 협업과제 발굴",
        "기술 적합성 및 실증 가능성 기반 스타트업 소싱",
        "지원기업 평가 및 최종 협업기업 선발",
        "현업부서-스타트업 PoC 계획 수립",
        "진행현황 및 KPI 모니터링",
      ],
      tags: [],
    ...
    },
    {
      ...
      client: "현대자동차그룹",
      program: "ZERO1NE",
      category: "Deep-tech Sourcing · Startup Acceleration",
      message: "산업·R&D 데이터 기반 딥테크 스타트업 발굴",
      counts: [],
      funnel: null,
      stats: [
        { value: 397, label: "방산 기술기업 롱리스트" },
        { value: 7, label: "선정 스타트업" },
      ],
      flow: [],
      bullets: [
        "R&D 및 산업 데이터 기반 기술기업 조사",
        "방산 관련 기술기업 397개사 롱리스트 구축",
        "기술영역별 기업 분류 및 검증",
        "선정 7개사 대상 투자·사업성 관점 멘토링 운영 지원",
      ],
    ...
    },
    {
      ...
      message: "현업 기술수요 기반 스타트업 발굴 및 협업",
      counts: [],
      funnel: null,
      stats: [],
      flow: [],
