...
export const OPEN_INNOVATION = {
  ...
  projects: [
    ...
    },
    {
      ...
      bullets: [
        "현업부서 인터뷰 기반 협업과제 발굴",
        "기술 적합성 및 실증 가능성 기반 스타트업 소싱·평가",
        "선정기업-현업부서 간 PoC 계획 수립 및 진행 모니터링",
      ],
      tags: [],
      highlight: "",
    },
    {
      ...
      recruitment: [],
      message:
        "방산 분야 기술기업 397개사를 조사해 후보군을 구축하고, ZERO1NE Sprint에서 선정 7개사의 성장지원 프로그램을 운영했습니다.",
      counts: [],
      funnel: null as { steps: string[]; labels: string[]; } | null,
      stats: [
        { value: 397, label: "방산 기술기업 롱리스트" },
        { value: 7, label: "선정 스타트업 성장지원" },
      ],
      flow: [],
      bullets: [
        "산업·R&D 데이터 기반 방산 기술기업 조사 및 후보군 구축",
        "선정 스타트업 성장지원 프로그램 운영",
        "기업별 프로그램 참여 및 진행현황 관리",
      ],
      tags: [],
      highlight: "",
    },
    {
      ...
      message:
        "현업 협업과제에 적합한 스타트업을 모집·검토하고 평가를 통해 최종 협업 후보를 선발했습니다.",
      counts: [],
      funnel: null as { steps: string[]; labels: string[]; } | null,
      stats: [],
      flow: ["모집", "검토", "평가", "선발"],
      bullets: [
        "현업 협업과제 기반 스타트업 모집 및 지원기업 검토",
        "오피스아워·평가를 통한 협업 적합성 검증 및 선발",
        "프로그램 진행 중 신규 기술수요 발생 시 적합 스타트업 추가 소싱·추천",
      ],
      tags: [],
      highlight: "",
    },
